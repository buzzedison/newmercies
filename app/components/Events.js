...
export default function EventPage() {
  return (
    <div className="bg-orange-50"id="events">
    <div className="container mx-auto mt-20 px-4 md:px-12 py-10">
      <div className="flex flex-wrap justify-center items-center">
        ...
        <div className="w-full md:w-1/2 pl-10 py-10">
          ...
          <p className="text-gray-600 mt-6">
            ...
            <p className="mt-2">
            Our conference halls are perfect for church services, church retreats, and engagements. 
            We also have rooms available for booking for single use and groups who hold events in our event spaces.</p>
        ...
        <div className="w-full md:w-1/2 pr-5 pl-12 hover:opacity-80">
          <Image 
