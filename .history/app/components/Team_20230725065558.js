  ...
  return (
    <div className="container mx-auto my-20 px-4 md:px-12" id="team">
      <div className="text-center">
        ...
        <p>It is of the LORD's mercies that we are not consumed Because his compassions fail not.<br/> They are new every morning: Great is thy faithfulness. Lamentations 3:22-23</p>
      </div>
