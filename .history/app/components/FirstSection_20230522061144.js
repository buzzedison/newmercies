    ...
    <div className="container mx-auto my-20 px-4 md:px-12" id="about">
      <div className="flex items-center">
        ...
        <div className="w-full md:w-1/2 pl-10">
          ...
          New Mercies Christian Retreat Center has its foundation in Isaiah 55:6. 
          <span className="font-semibold text-lg text-orange-600 py-2">“Seek the Lord while he may be found; call on him while he is near.”</span>
...
in our experience, ought to dedicate themselves to a time for prayer. For this reason, we are here to nourish your walk with God, and we endeavour to provide a setting for closeness with God, biblical study, and seeking God's face within the constraints of a safe space. A very warm welcome awaits your visit.
