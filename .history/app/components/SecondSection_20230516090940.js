  ...
  return (
    <div>
        ...
        <div className="max-w-lg mx-auto">
            ...
            <button className="px-5 py-2 mt-6 text-lg font-bold leading-5 text-center text-white capitalize bg-blue-600 rounded-lg hover:bg-blue-500 lg:mx-0 lg:w-auto focus:outline-none">
          View Gallery
            </button>
