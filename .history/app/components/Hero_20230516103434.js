...
export default function Hero() {
  return (
    <div className=" bg-gray-700 opacity-30">
    <div class="carousel w-full">
      <div id="slide1" class="carousel-item relative w-full h-screen">
        ...
        <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
          <a href="#slide4" class="btn btn-circle text-white bg-blue-600 hover:bg-blue-800">❮</a>  
          <a href="#slide2" class="btn btn-circle text-white bg-blue-600 hover:bg-blue-800">❯</a> 
        </div>
      </div>
