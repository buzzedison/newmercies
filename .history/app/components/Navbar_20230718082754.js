  ...
  return (
    ...
    <nav className="flex items-center justify-between px-4 py-4">
      ...
      {/* <div className="hidden md:flex space-x-4">
        ...
        <Link href="/facilities"className="text-lg font-medium text-gray-700 hover:text-gray-900">
            Facilities
      ...
      <div
        ...
        } absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out md:mt-0 md:p-0 md:top-0 md:relative md:bg-white md:w-auto md:opacity-100 md:translate-x-0 md:flex md:items-center`}
      >
        ...
        <Link href="#about"className="my-2 text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-blue-500 dark:hover:text-blue-400 md:mx-4 md:my-0">
          ...
          <Link href="#retreat-rooms"className="my-2 text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-blue-500 dark:hover:text-blue-400 md:mx-4 md:my-0">
          Accomodation 
...
<Link href="#team"className="my-2 text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-blue-500 dark:hover:text-blue-400 md:mx-4 md:my-0">
            The Team 
