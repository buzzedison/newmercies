    ...
    <div class="carousel w-full">
      <div id="slide1" class="carousel-item relative w-full h-screen">
        ...
        <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
          <h1 class="text-4xl font-bold text-white leading-none md:text-6xl">New Mercies Retreat Centre</h1>
          <p class="text-xl mt-6 font-light text-gray-200">A peaceful setting with stunning views, comfortable accommodations
delicious food, 
a variety of activities</p>
      ...
      <div id="slide2" class="carousel-item relative w-full h-screen">
        ...
        <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
          ...
          Our luxury suites feature spacious living and sleeping areas, as well as a private balcony or patio with stunning views.
Our suites are equipped with all the amenities you need to relax and pamper yourself, including a king-size bed, a plush sofa, a marble bathroom with a 
soaking tub and separate shower, and a fully stocked minibar.</p>
        </div>   
        <div class="absolute flex justify-between transform -translate-y-1/2 left-5 right-5 top-1/2">
