  ...
  return (
    <div className="relative w-full h-screen">
      ...
      >
        <SwiperSlide>
          <div className="carousel-item w-full h-screen">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center z-30">
              <h1 className="text-5xl font-bold text-white leading-tight md:text-7xl">
              New Mercies
            Retreat Centre
              </h1>
              ...
              <div className="mt-8">
                <button className="bg-orange-600 text-white px-8 py-3 rounded-full font-semibold mr-4">Book Now</button>
                <button className="border-2 border-orange-600 text-orange-600 px-8 py-3 rounded-full font-semibold">Learn More</button>
              </div>
            </div>
          </div>
        </SwiperSlide>
        ...
        <SwiperSlide>
          <div className="carousel-item w-full h-screen">
            <Image src="/image/suite.jpg" layout="fill" objectFit="cover" className="z-10" />
            <div className="absolute inset-0 bg-black bg-opacity-50 z-20"></div>
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center z-30">
              ...
              <div className="mt-8">
                <button className="bg-blue-600 text-white px-8 py-3 rounded-full font-semibold mr-4">Book Now</button>
                <button className="border-2 border-blue-600 text-blue-600 px-8 py-3 rounded-full font-semibold">Learn More</button>
              </div>
            </div>
          </div>
        </SwiperSlide>
