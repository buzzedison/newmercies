          ...
          <div className="carousel-item w-full h-screen">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center z-30">
              <h1 className="text-5xl font-bold text-white leading-tight md:text-7xl">
                <span className="text-white">New Mercies</span>
                <span className="text-orange">Retreat Centre</span>
              </h1>
        ...
        <SwiperSlide>
          <div className="carousel-item w-full h-screen">
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center z-30">
              ...
              <div className="mt-8">
                <button className="bg-blue-600 text-white px-8 py-3 rounded-full font-semibold mr-4">Book Now</button>
                <button className="border-2 border-blue-600 text-blue-600 px-8 py-3 rounded-full font
-semibold">Learn More</button>  
</div>
</div>
</div>
</SwiperSlide>
