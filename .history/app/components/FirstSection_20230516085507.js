  ...
  return (
    ...
    <div class="flex items-center my-20">
      ...
      <div class="w-1/2 pl-10">
        ...
        <p class="text-gray-600 mt-6">New Mercies Retreat Centre is a place where you can come to escape the hustle and bustle of everyday life. We offer a variety of 
