    ...
    <div className="container mx-auto my-20 px-4 md:px-12" id="about">
      <div className="flex items-center">
        ...
        <div className="w-full md:w-1/2 pl-10">
          ...
          <div  className="font-semibold text-lg text-orange-600 py-2">
...
<div className="mt-2">For this reason, we are here to nourish your walk with God, and we endeavour to provide a setting for closeness with God, biblical study, and seeking God's face within the constraints of a safe space.
</div>
