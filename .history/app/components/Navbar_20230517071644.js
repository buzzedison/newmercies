    ...
    <nav className="flex items-center justify-between px-4 py-4">
      ...
      >
        <div className="flex flex-col md:flex-row md:mx-6">
          ...
          <Link href="#abouts"className="my-2 text-gray-700 transition-colors duration-300 transform dark:text-gray-200 hover:text-blue-500 dark:hover:text-blue-400 md:mx-4 md:my-0">
              About Us
